...
namespace Autopal.BrainBay.RickandMorty.Scrapper.Connector.Model
{
    public class Character
    {
        ...
        public Character(int id = 0, string name = "", CharacterStatus status = 0,
            ...
            CharacterLocation location = null, CharacterLocation origin = null, Uri image = null,
        ...
        /// </summary>
        public CharacterLocation Origin { get; }

        /// <summary>
        ///     Gets link to the character's image. All images are 300x300px and most are medium shots or portraits since they are
